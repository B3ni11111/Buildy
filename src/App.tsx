...
import { CssBaseline, ThemeProvider, createTheme, type Theme } from '@mui/material';
...
function App() {
  ...
  if (!isAuthenticated) {
    ...
    content = <Settings profile={profile} onUpdateProfile={setProfile} onBack={() => setShowSettings(false)} />;
  } else {
    content = <Dashboard profile={profile} onViewUserInfo={() => setShowSettings(true)} />;
  }
